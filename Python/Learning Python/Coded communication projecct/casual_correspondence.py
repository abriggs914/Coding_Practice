...
print(caesar_cipher_encode(first_message, caesar_offset))
second_message = "bqdradyuzs ygxfubxq omqemd oubtqde fa oapq kagd yqeemsqe ue qhqz yadq eqogdq!"
print(caesar_cipher_encode(second_message, caesar_offset))
...
key = "dog"
decoded_message = "barry is the spy"
encoded_message = encode_vigenere(decoded_message, key)
print(encoded_message)

key = "friends"
encoded_message = "dfc aruw fsti gr vjtwhr wznj? vmph otis! cbx swv jipreneo uhllj kpi rahjib eg fjdkwkedhmp!"
decoded_message = decode_vigenere(encoded_message, key)
...
encoded_message = encode_vigenere(decoded_message, key)
print(encoded_message)
print("Right?" + str(original_message == encoded_message))
#Conclusion
