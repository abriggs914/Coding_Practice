...
def animate():
    ...
    while True:
        ...
        canvas.itemconfigure(light1, fill=random.choice(colors))
        canvas.itemconfigure(light2, fill=random.choice(colors))
        canvas.itemconfigure(light3, fill=random.choice(colors))
        canvas.itemconfigure(light4, fill=random.choice(colors))
        canvas.itemconfigure(light5, fill=random.choice(colors))
        canvas.itemconfigure(light6, fill=random.choice(colors))
        canvas.itemconfigure(light7, fill=random.choice(colors))
        canvas.itemconfigure(light8, fill=random.choice(colors))
        # Update the canvas
        canvas.update()
