...
class NPC(AnimatedSprite):
    ...
    def movement(self):
        ...
        if next_pos not in self.game.object_handler.npc_positions:
            if DRAW_TWO_D_GAME:
                pg.draw.rect(self.game.screen, COLOUR_NPC_NEXT_MOVE, (100 * next_x, 100 * next_y, 100, 100))
...
class SoldierNPC(NPC):
    def __init__(self, game, path="resources/sprites/npc/soldier/0.png", pos=(10.5, 5.5), scale=0.6, shift=0.38, animation_time=100):
        super().__init__(game, path, pos, scale, shift, animation_time)
