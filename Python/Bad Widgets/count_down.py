...
fmt = "%Y-%m-%d %H:%M:%S"
game_time_can_vs_swi = datetime.datetime(2022, 12, 19, 18, 30)
game_time_can_vs_svk = datetime.datetime(2022, 12, 21, 19, 0)
game_time_can_vs_svk = datetime.datetime(2022, 12, 21, 19, 0)
game_time = game_time_can_vs_svk + datetime.timedelta(hours=-3.75)
