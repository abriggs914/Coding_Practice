...
def new_route(start_point=None, end_point=None):
  ...
  if shortest_route:
    ...
    print("Unfortunately, there is currently no path between {0} and {1} due to maintenance.\nHere are the current blockages: {2}".format(start_point, end_point, stations_under_construction))
...
#   print("a",a, 'b',b)
#   if (site in vc_metro.keys()):
#     #possible_sites = vc_metro
#     print("Adding {0} to the list of sites under construction".format(site))
#     stations_under_construction += [site]
#   elif (stations_under_construction and (site in stations_under_construction)):
#     print("construction at {0} has ended.".format(site))
#     stations_under_construction.remove(site)
#   else:
#     print("error")

stations_under_construction.append("Waterfron")
stations_under_construction.append("Burrard")
#update_construction("Waterfron")
