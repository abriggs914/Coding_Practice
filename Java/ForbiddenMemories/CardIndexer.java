...
public class CardIndexer{
  ...
  public static ArrayList<Card> enemyBoard = new ArrayList<Card>();
  ...
  public static void main(String[] args) throws CardException{
    parseCombinationsFile();
      ...
      */
      ...
      draw("Meotoko", 'b');
      draw("Mystery Hand", 'h');
      draw("Megirus Light", 'b');
      draw("Weather Control", 'h');
      // draw("Bean Soldier", 'b');
      // draw("Little Chimera", 'h');
      draw("Flower Wolf", 'b');
      draw("Hiro's Shadow Scout", 'h');
  ...
  public static void parseCombinationsFile(){
    try{
  ...
  public static void viewStarSigns(boolean userIsAttacker) throws CardException{
  ...
  public static void vssAttackSimulator(Card card) throws CardException{
    if(enemyBoard.size() > 0){
  ...
  */
  ...
  public static String[] cardStates(Card card){
  ...
  */
  ...
  public static ArrayList<Card> sortCardsByAttack(ArrayList<Card> arr){
...
*/
  ...
  */
  ...
  /**
    printCombos method is called to print the results of possibleFusionPartners.
    Works almost exactly the same way as printGetFusions().
    Prints pairs of cards in a Card A " + " Card B format. Returns void.
  */
  ...
  */
  ...
  public static String starSignAdvantage(String ss1Atk, String ss2Def) throws CardException{
  ...
  public static ArrayList<String> genTypeList(){
