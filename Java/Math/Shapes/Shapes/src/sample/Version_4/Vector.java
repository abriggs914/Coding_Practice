...
public class Vector {
    ...
    public Vector(double x1, double y1, double x2, double y2, double speed, double angle) {
...
//        Edge a = new Edge("side a", xd);
//        Edge b = new Edge("side b", yd);
//        Edge c = new Edge("side c", h);
//        Triangle t = new Triangle("", a, b, c, null, null, null);
...
//        System.out.println("ySpeed: " + ySpeed + ", xSpeed: " + xSpeed + ", yAngle: " + yAngle + ", xAngle: " + xAngle);
    ...
    public String toString() {
        String res =  speed + " m/s @ " + Utilities.twoDecimal(angle) + " degrees.";
        res += "\n(x1, y1): (" + x1 + ", " + y1 + ")" + "\n(x2, y2): (" + x2 + ", " + y2 + ")";
        res += "\np1: " + p1;
        res += "\np2: " + p2;
        return res;
    ...
    public static int cartesianQuadrant(Vector v) {
