...
public class Spelling {
     ...
     *
     * @param allPokemon A processed 2D array of all Pokemon names found in raw/pokedex.csv
     * @throws IOException
     */
    public Spelling(String[][] allPokemon) throws IOException {
