public class CardG{
	...
	public CardG(int index, int value, String suit, int id){
		this.index = index+1;
		this.value = value;
		this.suit = suit;
		this.id = id;
	...
	public CardG(int index, char faceValue, String suit, char mode, int id){
	...
	public void populateTakenCards(CardG[] arr, DeckG deckIn){
